function f=f_robotarm(z0,t,ts1,ts2,alpha,beta,gamma,W,the1,the2)
...
f=zeros(size(z0));
f(1)=z0(2);
f(2)=-alpha*(z0(1)-the1)-gamma*z0(2)+beta*sin(W*t);
f(3)=z0(4);
f(4)=-alpha*(z0(3)-the2)-gamma*(z0(4)+abs(z0(2)))+beta*sin(W*t);
