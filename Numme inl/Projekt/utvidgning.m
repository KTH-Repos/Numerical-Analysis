...
x0=0; xslut=0.5;
q = giss1;
[xut,yut] = Runge4(h, 0, 0.5, [(2*5.1*10^7)/(7.6*10^9*9.869604401*0.003) 0 0]);
...
y(1) = (2*5.1*10^7)/(7.6*10^9*9.869604401*0.003);                                        
z(1) = 0;                                          
x(1) = 0;

F_xyz = @(s,y,z,x) z; 
G_xyz = @(s,y,z,x) -q.*(10.2*10^7)/(7.6*10^9*q*0.003)*sqrt(1-z.^2);
